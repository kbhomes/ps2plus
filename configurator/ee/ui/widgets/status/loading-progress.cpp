...
void ImGui::Widgets::LoadingProgress(const char *label, float progress, const char *format) {
    ...
    RenderTextClipped(frame_bb.Min, frame_bb.Max, value_buf, value_buf + value_buf_len, NULL, ImVec2(0.5f, 0.5f));
}