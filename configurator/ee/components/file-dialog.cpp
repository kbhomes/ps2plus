...
namespace PS2Plus::Components {
    ...
    FileDialog_::FileDialog_(std::string initialDirectory)
    ...
    void FileDialog_::ScanSubdirectory(std::string directory)
    {
        ScanDirectory(joinpath(_currentDirectory, directory));
    }

    void FileDialog_::ScanParentDirectory()
    {
    ...
    void FileDialog_::SetDeviceList(std::vector<std::string> deviceList)
    {
        _deviceList = deviceList;
    }

    std::vector<std::string> FileDialog_::GetDeviceList()
    {
        return _deviceList;
    }

    std::vector<FileDialog_::Entry> FileDialog_::GetEntries() 
    {
        return _currentEntries;
    }

    std::vector<std::string> FileDialog_::GetDirectoryComponents()
    {
        return _currentDirectoryComponents;
    }

    std::string FileDialog_::GetCurrentDirectory()
    {
        return _currentDirectory;
    }

    std::string FileDialog_::GetSelectedPath()
    {
        return _selectedPath;
    }

    void FileDialog_::SetSelectedPath(std::string path)
    {
        _selectedPath = path;
    }

    bool FileDialog_::IsShowingDeviceList()
    {
