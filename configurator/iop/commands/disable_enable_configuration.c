...
void command_disable_enable_configuration(ps2plus_rpc_packet *packet) {
    ps2plus_rpc_command_disable_enable_configuration *command = &packet->disable_enable_configuration;
    ...
    // Transmit the value
    packet->ok = ps2plus_spi_transmit_mock(0x73, tx_, rx_, 1, rx_mock_disable_enable_configuration);
