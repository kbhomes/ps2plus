...
void test_command_ps2plus_get_version_firmware() {
  ...
  uint8_t *actual_output = helper_run_command(command_ps2plus_get_version.id, command_input, sizeof(command_input));
...
void test_command_ps2plus_get_version_microcontroller() {
  ...
  uint8_t *actual_output = helper_run_command(command_ps2plus_get_version.id, command_input, payload_size);
